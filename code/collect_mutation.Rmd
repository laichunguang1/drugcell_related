...
requiredPackages = c('here','compare',"dplyr","foreach","doParallel")
...
startTime <- Sys.time()
mutation_18Q2_filter=data.frame()

# for (i in 1:100000)
for (i in 1:dim(mutation_18Q2)[1])
    {
  rate=list()
  # if CGA_WES_AC=-, use RNAseq_NA, or make rate=0
  if((mutation_18Q2_2[i,28]=="")==FALSE)
  {rate=strsplit(mutation_18Q2_2[i,28],":")}
  else if((mutation_18Q2_2[i,29]=="")==FALSE)
  {rate=strsplit(mutation_18Q2_2[i,29],":")}
  else
    {rate=list(c(0,1))}
  ...
  if (rate1>threshold)
    {mutation_18Q2_filter=rbind(mutation_18Q2_filter, cbind(mutation_18Q2_2[i,],rate1))}
}

mutation_18Q2_filter_0.5=mutation_18Q2_filter
...
startTime <- Sys.time()
mutation_22Q1_filter=data.frame()
...
mutation_22Q1_filter=foreach (i=1:dim(mutation_22Q1)[1],.combine=rbind) %dopar%

# mutation_22Q1_filter=foreach (i=1:10000,.combine=rbind) %dopar%

# for (i in 1:40000)
# for (i in 1:dim(mutation_22Q1)[1])
    {
  rate=list()
  # if CGA_WES_AC=-, use RNAseq_NA, or make rate=0
...
mutation_22Q1_filter_0.5=mutation_22Q1_filter
...
mutation_22Q1_filter_0.5_2=mutation_22Q1_filter
